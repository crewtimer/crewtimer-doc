...
* [CrewTimer Firmware Image 3.09](https://storage.googleapis.com/resources.crewtimer.com/firmware/crewtimer-3.09.uf2)
...
| Version | Date       | Notes                                                                                                                                        |
| ------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| 4.03    | 2026-06-08 | Dev release only. Restore multiclick for firmware updating.                     |
| 4.01    | 2026-05-26 | Dev release only. Add support for Beach Buttons and direct BLE messages for horn, relay, and lights                    |
